...
class Testclass2(Testclass1): #incase we write Testclass2(Testclass1): --> inheritence occurs and we are able to extend the setup and teardown methods from the parent class
